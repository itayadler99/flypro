...
const methods = [
  {
    ...
    en: "Positioning",
    desc: "תל אביב → אתונה ב-₪220. משם טיסה זולה לכל אירופה ב-₪110. במקום ₪1,500 ישיר — ₪330 סה״כ.",
  },
  {
    n: "02",
  ...
  },
  {
    ...
    title: "טעויות תמחור",
    en: "Error Fares",
    desc: "טיסות שמתומחרות לא נכון. ניו יורק→טוקיו במחלקה ראשונה ב-₪1,650. איך לזהות ולפעול ב-15 דקות.",
  },
  {
    n: "05",
...
const faqs = [
  ...
  },
  {
    ...
    a: "כן. כל מודול מצולם עם הקלטת מסך. אתה פשוט עוקב אחרי. אין צורך בידע מוקדם. סבא שלי בן 72 השלים את המערכת ב-3 ימים וטס לקפריסין ב-₪400.",
  },
  {
    ...
    <div className="bg-glow min-h-screen">
      ...
      <section className="px-5 pt-20 pb-24 max-w-6xl mx-auto text-center">
        ...
        <div className="grid grid-cols-3 gap-4 max-w-3xl mx-auto pt-8 border-t border-white/5">
          ...
          <div>
            <div className="text-3xl md:text-4xl font-black text-gradient">₪510</div>
            <div className="text-sm text-zinc-500 mt-1">תל אביב → לונדון</div>
          </div>
          <div>
            <div className="text-3xl md:text-4xl font-black text-gradient">₪1,170</div>
      ...
      <section className="px-5 py-24 max-w-4xl mx-auto">
        ...
        <div className="space-y-6 text-lg md:text-xl text-zinc-300 leading-relaxed">
          <p>
            ראית פעם פוסט של מישהו שטס לאירופה ב-₪300?
            ניסית לחפש את אותה טיסה — ויצא לך ₪1,500.
          </p>
          <p>
        ...
        <div className="card rounded-3xl p-8 md:p-14">
          ...
          <div className="space-y-5 text-lg text-zinc-300 leading-relaxed">
            ...
            <p>
              ...
              ביקשנו תשובה אחת: <span className="text-white font-medium">איך טיסה אחת ב-3 מסלולים שונים עולה ₪320, ₪700, ו-₪3,100?</span>
            </p>
            <p>
          ...
          {[
            {
              ...
              desc: "התראה בטלגרם כל פעם שיש טעות תמחור או דיל מטורף מתל אביב. בזמן אמת. 24/7. דוגמאות אחרונות: ת״א-טוקיו ב-₪1,150, ת״א-ניו יורק ב-₪820.",
            },
            {
              tag: "בונוס 2",
              value: "₪299",
              title: "מאגר 50 טעויות תמחור",
              desc: "50 דילים שעלו בשנתיים האחרונות. כל אחד מנותח: מה היה הקוד, איך זוהו, איך לזהות את הבא. דוגמאות: ת״א-בנגקוק ₪900, ת״א-מקסיקו ₪1,400.",
            },
            {
              tag: "בונוס 3",
              value: "₪399",
              title: "מדריך טיסות פרימיום בכסף קטן",
              desc: "מחלקה ראשונה מ-₪1,600 במקום ₪15,000. השיטה לטעויות תמחור של המחלקות העליונות. כולל רשימת חברות שעושות את זה הכי הרבה.",
            },
            {
              tag: "בונוס 4",
              value: "₪243",
